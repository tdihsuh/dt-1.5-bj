<template>
    <div class="memo-content">
        <Tabs class="memo-tabs" :value="status" @on-click="changeTab">
            <TabPane :label="labelPublish" name="publish" ><MemoTable :columns="columnsPublish" :data='dataPublish' :is-publish ="true"></MemoTable></TabPane>
            <TabPane :label="labelUnpublish" name="unpublish"><MemoTable :columns="columnsUnpublish" :data='dataUnpublish' :is-publish ="false"></MemoTable></TabPane>
        ...
        <Modal   v-model="isShowDetails" width="1000px" >
            ...
            <div class="details-content">
                ...
                <div class="item-tag clear"><span class="item-name">标签：</span><span class="item-content"><span class="tag">重大违法税收</span></span></div>
